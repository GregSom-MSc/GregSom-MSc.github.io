fetch('sm_library.json')
    ...
    .then(papers => {
        ...
        papers.forEach((paper, index) => {
            ...
            abstractButton.style.backgroundColor = "#134074"; // Lighter blue background, background-color, see comparison: #134074 #13315C
            ...
            abstractDiv.innerHTML = `<div style="text-align: justify; font-size: smaller; max-width: 80%;">${paper.abstract}</div>`;
